...
class FairnessMetrics():
    ...
    def set_auc_other(self, pred, targets, n_iter, dataset):
        ...
        for group in dataset.subgroup_indexes:
            ...
            group_transpose = [(i % targets_len) -1 for i in group]
            pred_group = pred[group_transpose]
            # transform group indexes to targets-len 
            targets_group = targets[group_transpose]
